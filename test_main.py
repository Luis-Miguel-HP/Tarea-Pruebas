...
def test_pruebaButton():
    ...
    driver.get_screenshot_as_file('C:\\Users\\Luis Miguel\\OneDrive\\Escritorio\\Prueba\\screenshot\\prueba_button.png')
    assert True
...
def test_pruebaLogin():
    ...
    driver.get_screenshot_as_file('C:\\Users\\Luis Miguel\\OneDrive\\Escritorio\\Prueba\\screenshot\\prueba_login.png')
    assert True
...
def test_pruebaSearch():
    ...
    driver.get_screenshot_as_file('C:\\Users\\Luis Miguel\\OneDrive\\Escritorio\\Prueba\\screenshot\\prueba_search.png')
    assert True
...
def test_pruebaLogo():
    ...
    driver.get_screenshot_as_file('C:\\Users\\Luis Miguel\\OneDrive\\Escritorio\\Prueba\\screenshot\\prueba_logo.png')
    assert True
...
def test_pruebaFavorites():
    ...
    driver.get_screenshot_as_file('C:\\Users\\Luis Miguel\\OneDrive\\Escritorio\\Prueba\\screenshot\\prueba_buttonFavorites.png')
    assert True
